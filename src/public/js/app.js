(function () {
  ...
  function renderTodos(todos) {
    ...
    todoList.innerHTML = todos.map(function (todo) {
      ...
      var scheduledHtml = todo.scheduled_at
        ? '<span class="todo-scheduled" title="Scheduled">&#128337; ' + formatDateTime(todo.scheduled_at) + '</span>'
        : '';
  ...
  async function handleCreateTodo(e) {
    ...
    var scheduledAt = localInputToISO(document.getElementById('todoScheduledAt').value);
  ...
  async function openEdit(id) {
    try {
      ...
      document.getElementById('editScheduledAt').value = isoToLocalInput(todo.scheduled_at);
  ...
  async function handleEditTodo(e) {
    ...
    var scheduledAt = localInputToISO(document.getElementById('editScheduledAt').value);
  ...
  // Convert a datetime-local input value (local time, no zone) to a full ISO 8601 string.
  ...
  // Convert a stored ISO 8601 string to a datetime-local input value in local time.
